<ul id="nav">
    ...
    <li><a href="#"><i class="fa fa-users" aria-hidden="true"></i> Cliente</a>
        <ul class="subs">
            <ul>
                <li><a href="ControlCliente?accion=registrar"><i class="fa fa-folder-open" aria-hidden="true"></i>  Cliente</a></li>
            </ul>
            <ul>
                <li><a href="#"><i class="fa fa-folder-open" aria-hidden="true"></i>  Asignación</a></li>
            </ul>
            <ul>
                <li><a href="ControlCliente?accion=listar"><i class="fa fa-folder-open" aria-hidden="true"></i>  Listado</a></li>
            </ul>
        </ul>
    </li>
